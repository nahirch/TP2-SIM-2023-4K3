Public Class GeneradorVariables
    ...
    Sub New()
        random = New Random
    End Sub
    'Generador de numeros random para la distribucion Uniforme
    ...
    End Function
    'Generador de numeros random para la distribucion Exponencial
    ...
    End Function
    'Generador de numeros random para la distribucion Normal con el metodo de convolucion
